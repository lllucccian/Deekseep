...
cp "$ROOT/module-universal/ds-probe-universal.apk" \
    "$DIST/deekseep-google-play-universal-api82-100-101-102-v1.7.3.apk"
...
API102_APK="$ROOT/module/ds-probe-google-play.apk"
UNIVERSAL_APK="$DIST/deekseep-google-play-universal-api82-100-101-102-v1.7.3.apk"
